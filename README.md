...
YT Music Lite 7.2 is a browser-free Windows music client focused on low memory use. It provides YouTube search, saved music, local and imported YouTube playlists, a history-driven Discover Weekly mix, a playback queue, local audio, media keys, a mini player, and verified in-app updates.
...
Download `YTMusicLite-v7.2.0-win-x64-setup.exe` from the latest GitHub release. A portable ZIP is also provided and is used by the verified in-app updater.
